...
int main(void)
{
    ...
    CHECK(OTA_DEBUG_UART_INSTANCE == UINT8_C(0));
    CHECK(OTA_OTA_UART_INSTANCE == UINT8_C(1));
    CHECK(OTA_OTA_UART_RX_GPIO_PORT_INDEX == OTA_GPIO_PORT_B_INDEX);
    CHECK(OTA_OTA_UART_RX_GPIO_PIN_INDEX == UINT8_C(0));
    CHECK(OTA_OTA_UART_TX_GPIO_PORT_INDEX == OTA_GPIO_PORT_B_INDEX);
    CHECK(OTA_OTA_UART_TX_GPIO_PIN_INDEX == UINT8_C(1));
